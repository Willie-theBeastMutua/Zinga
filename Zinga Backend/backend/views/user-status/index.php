								...
								[
									...
									'buttons' => [
										...
										'view' => function ($url, $model) use ($rights) {
											return (isset($rights->view)) ? Html::a('<i class="ft-eye"></i> View', ['view', 'id' => $model->userStatusId], ['class' => 'btn-sm btn-primary']) : '';
										},
										'delete' => function ($url, $model) use ($rights) {
											return (isset($rights->delete)) ? Html::a('<i class="ft-trash"></i> Delete', ['delete', 'id' => $model->userStatusId], [
