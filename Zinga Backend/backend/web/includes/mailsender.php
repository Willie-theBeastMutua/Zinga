...
function SendMail($EmailArray,$Subject,$Message, $Attachment)
{
	// Send mail
	$mail = new PHPMailer();
	...
	$mail->Host = "ssl://kaboi.tafutaa.com"; // SMTP server
	$mail->Username = "joseph@kaboi.tafutaa.com";
	$mail->Password = "M@yaiMbili2!"; 
	           
	//$mail->Port = 25; // optional if you don't want to use the default 
			
	$mail->From = "joseph@kaboi.tafutaa.com";
